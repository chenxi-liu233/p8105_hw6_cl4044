...
| :---------- | ---------: | -------: | ---------------: | -------------: |
| (Intercept) |      7.165 |    0.254 |            0.913 |           0.01 |
| tmin        |      1.041 |    0.014 |            0.913 |           0.01 |

The table above showed the mean of estimate, the standard deviation of
estimate and mean of rsquared after bootstrap 5000 times.
...
The distribution of r^2 is approximately normal with the mean 0.911 and
the standard error of 0.009.
...
The distribution of log(beta0 hat \* beta1 hat). is approximately
normal, with the mean 2.013 and the standard error of 0.024.
...
The 95% confidence interval for r^2 is 0.8958802, 0.9292654.

The 95% confidence interval for log(beta0 hat \* beta1 hat) is (0.8530,
0.8945).
